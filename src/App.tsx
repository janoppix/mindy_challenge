...
const App = () => {
  ...
  // Obtiene los años disponibles para el indicador actual
  ...
  // Filtra la serie de datos por año y mes seleccionados
  const datosFiltrados = data?.serie ? filtrarSerie(data.serie, year, month) : [];

  // Determina el color de los mensajes en base a si hay datos o no
  const statusClass = datosFiltrados == null || !datosFiltrados.length ? 'orange' : 'teal';

  // Obtiene la etiqueta del indicador y mes seleccionado
            ...
            <div className="flex">
              ...
              <div>
                ...
                {loading ? (
                  ...
                  <p>Seleccione un indicador año y mes...</p>
                ) : !year ? (
                  <p>Seleccione un año...</p>
                ) : !month ? (
                  <p>Seleccione un mes...</p>
                ) : !datosFiltrados.length ? (
                  <p>No se encontraron datos para el período especificado...</p>
                ) : null}
              </div>
            </div>
          </div>
